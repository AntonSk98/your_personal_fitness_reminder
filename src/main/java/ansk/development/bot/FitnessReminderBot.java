...
import ansk.development.service.impl.ScheduledJobsService;
...
public class FitnessReminderBot extends TelegramLongPollingBot {
    ...
    public static FitnessReminderBot getFitnessBot() {
        if (fitnessReminderBot == null) {
            fitnessReminderBot = new FitnessReminderBot(ConfigRegistry.props().botProperties().getToken());
        }
    ...
    public String getBotUsername() {
        return ConfigRegistry.props().botProperties().getUsername();
    }
